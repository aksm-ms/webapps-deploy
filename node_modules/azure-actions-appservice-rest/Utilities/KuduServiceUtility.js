...
class KuduServiceUtility {
    ...
    deployUsingZipDeploy(packagePath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // console.log(`in deployUsingZipDeploy: deploymentDetails: ${deploymentDetails}`);
                core.info(`in deployUsingZipDeploy: deploymentDetails: ${deploymentDetails}`);
                core.info("type of deploymentDetails: " + typeof (deploymentDetails));
                core.info(`deploymentdetails json: ${JSON.stringify(deploymentDetails)}`);
                console.log(" if deploymentDetails is null: " + deploymentDetails === null);
    ...
    _processDeploymentResponse(deploymentDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                core.info(`in _processDeploymentResponse: deploymentDetails: ${deploymentDetails}`);
                core.info("type of deploymentDetails: " + typeof (deploymentDetails));
                core.info(`deploymentdetails json: ${JSON.stringify(deploymentDetails)}`);
                // console.log(`in _processDeploymentResponse: deploymentDetails: ${deploymentDetails}`);
                console.log(" if deploymentDetails is null: " + deploymentDetails === null);
                var kuduDeploymentDetails = yield this._webAppKuduService.getDeploymentDetails(deploymentDetails.id);
                console.log(`kuduDeploymentDetails: ${kuduDeploymentDetails}`);
    ...
    deployWebAppImage(appName, images, isLinux) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let deploymentDetails = yield this._webAppKuduService.imageDeploy(images, headers);
                yield this._processDeploymentResponse(deploymentDetails);
                return deploymentDetails.id;
            }
            catch (error) {
